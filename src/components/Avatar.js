...
const Avatar = ({ body, eyes, hair, clothing1, clothing2, clothing3, mouth, eyebrow, glasses, noses, earrings, hats, neckwear}, ref) => {
	return (
		<div className="avatar">
            ...
            <Part path="noses" index={noses} zIndex={5} />
            <Part path="accessories/earrings" index={earrings} zIndex={7} />
            <Part path="accessories/hats" index={hats} zIndex={8} />
